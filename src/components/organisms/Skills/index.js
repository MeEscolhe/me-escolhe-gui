...
export const TagList = ({ title, hardSkills, softSkills, languages }) => {
    const skills = hardSkills ? hardSkills : softSkills ? softSkills : languages
    const levels = hardSkills ? [1, 2, 3, 4, 5] : languages ? [1, 2, 3] : []
