...
export { default as TeacherProfile } from './Profile Teacher'
...
export { default as CreateCandidateAccount } from './Create Candidate Account'
export { default as CreateRecruiterAccount } from './Create Recruiter Account'
